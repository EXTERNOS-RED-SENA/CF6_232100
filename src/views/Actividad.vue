      ...
      .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
        .col-6.col-md-4.col-lg-3.mb-4.mb-md-0
          .tarjeta.h-100.d-flex.align-items-center.p-4
            figure
              img(src="@/assets/bullets/Falso_Verdadero.svg", alt="Texto que describa la imagen")
        .col-12.col-md-8.col-lg-9
          .titulo-segundo
            h2 Prueba tus conocimientos sobre gestión y análisis de datos para el monitoreo de labores agrícolas
          p.mb-4 Validar el conocimiento adquirido sobre gestión y análisis de datos para el monitoreo de labores agrícolas. Esto se trabaja a partir de un conjunto de preguntas con el propósito de buscar una dinámica de razonamiento ágil sobre opciones cerradas y reafirmar un conocimiento declarado dentro del componente.
